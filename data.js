(function () {
  ...
  const ATTRIBUTE_IMPACTS = {
    threePT: ['三分出手占比与三分命中率', '外线得分产量', '为球队提供空间加成'],
    MID: ['中距离命中率', '罚球命中率', '半场阵地战与关键投篮稳定性'],
    FIN: ['篮下两分命中率', '造罚球能力', '突破与内线得分产量'],
    DNK: ['篮下终结效率', '冲击篮筐得分', '运动能力衰退后的终结保持'],
    HAN: ['球权使用率与持球角色', '助攻产量', '失误控制与自主进攻'],
    PAS: ['球权上限与组织角色', '助攻产量', '球队进攻战力和失误控制'],
    PDEF: ['抢断产量', '外线防守评分', 'DPOY与季后赛防守战力'],
    IDEF: ['禁区防守评分', '盖帽辅助', '季后赛护筐与对位战力'],
    BLK: ['盖帽产量', '护筐战力', 'DPOY评选'],
    REB: ['篮板产量', '防守回合终结', '季后赛阵容适配'],
    ATH: ['得分、篮板、抢断和盖帽的运动加成', '突破与扣篮表现', '年龄和伤病后的衰退敏感度'],
    STR: ['篮板争抢与对抗终结', '内线攻防表现', '年龄和伤病后的衰退敏感度'],
    CLU: ['罚球与关键投篮稳定性', '高压回合失误控制', '季后赛表现与历史级属性解锁'],
    POT: ['影响休赛期训练点产出', '年龄越大兑现比例越低，但不会使训练点归零', '不直接提升比赛数据，也不等于巅峰总评']
  };
